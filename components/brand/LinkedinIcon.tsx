// LinkedIn glyph — lucide-react (v1) dropped brand/social icons, so we
// ship the mark ourselves. `size` matches the lucide icon API; `fill`
// uses currentColor so it inherits text colour like the other icons.
